...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{) }\CommentTok{# 한글 주석! }
\end{Highlighting}
\end{Shaded}

\includegraphics{M25-pdf_files/figure-latex/unnamed-chunk-1-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{c}\NormalTok{(}\StringTok{"한글"}\NormalTok{, }\StringTok{"벡터"}\NormalTok{)  }
\end{Highlighting}
\end{Shaded}
...
\includegraphics{M25-pdf_files/figure-latex/pressure-1.pdf}
